...
<html>
    ...
    <body>
        ...
        <div id="show-modelos" class="content scaffold-show" role="main">
            ...
            <f:display bean="modelos" />
            <g:form resource="${this.modelos}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.modelos}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
                    <input class="delete" type="submit" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
                    <g:link class="create" controller="modelos" action="crearPresupuesto" id="${this.modelos.id}">Enviar presupuesto</g:link>
                </fieldset>
            </g:form>
        </div>
    </body>
