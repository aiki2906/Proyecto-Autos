...
<html>
    ...
    <body>
        ...
        <div id="show-marca" class="content scaffold-show" role="main">
            ...
            <f:display bean="marca" />
            <g:form resource="${this.marca}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.marca}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
